...
Usage: sh tcp_echo_server.sh ${0##*/} [alpine|centos|trusty|xenial|zesty|bionic]
...
docker run --privileged -it --rm -p 8080:8080 -p 8008:8008 --name echo --entrypoint /bin/bash polyverse/tcp_echo_server.$1
